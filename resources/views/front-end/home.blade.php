                    ...
                    <div class="col-lg-12 active-hot-deal-carusel ">
                        ...
                        <div class="single-carusel">
                            <div class="thumb relative">
                                <img class="img-fluid" src="app/public/data_img{{ $item->filenames1 }}" alt="">
                            </div>
                        ...
                        <div class="single-carusel">
                            <div class="thumb relative">
                                ...
                                <img class="img-fluid" src="app/public/data_img{{ $item->filenames2 }}" alt="" >
                            </div>
                            <div class="price-detials">
                                <div class="row">
                                    <div class="col-lg-6 col-sm-6 mb-5 hovo"><a href="#" class="price-btn"><span><i class="fa fa-heart" aria-hidden="true"></i></span></a></div>
                        ...
                        <div class="single-carusel">
                            <div class="thumb relative">
                                ...
                                <img class="img-fluid" src="app/public/data_img{{ $item->filenames3 }}" alt="">
                            </div>
                            <div class="price-detials">
                                <div class="row">
                                    <div class="col-lg-6 col-sm-6 mb-5 hovo"><a href="#" class="price-btn"><span><i class="fa fa-heart" aria-hidden="true"></i></span></a></div>
                            ...
                            <div class="single-carusel">
                                <div class="thumb relative">
                                    ...
                                    <img class="img-fluid" src="app/public/data_img{{ $item->filenames4 }}" alt="">
                                </div>
                                <div class="price-detials">
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-6 mb-5 hovo"><a href="#" class="price-btn"><span><i class="fa fa-heart" aria-hidden="true"></i></span></a></div>
                                ...
                                <div class="single-carusel">
                                    <div class="thumb relative">
                                        ...
                                        <img class="img-fluid" src="app/public/data_img{{ $item->filenames5 }}" alt="">
                                    </div>
                                    <div class="price-detials">
                                        <div class="row">
                                            <div class="col-lg-6 col-sm-6 mb-5 hovo"><a href="#" class="price-btn"><span><i class="fa fa-heart" aria-hidden="true"></i></span></a></div>
                                    ...
                                    <div class="single-carusel">
                                        <div class="thumb relative">
                                            ...
                                            <img class="img-fluid" src="app/public/data_img{{ $item->filenames6 }}" alt="">
                                        </div>
                                        <div class="price-detials">
                                            <div class="row">
                                                <div class="col-lg-6 col-sm-6 mb-5 hovo"><a href="#" class="price-btn"><span><i class="fa fa-heart" aria-hidden="true"></i></span></a></div>
