  ...
  <!-- start form -->
			<main class="content">
				<div class="container-fluid p-0" id="product">
					...
					<table class="table table-dark table-striped table-bordered border-dark">
                        ...
                        <tbody>
                          ...
                          <tr class=" ">
							...
							<td>
								<a  data-bs-toggle="modal" href="" data-bs-target="#ModalDelete{{ $contact->id }}" class="btn btn-danger" ><i class="fas fa-comment-dots"></i> supprimer</a>
							</td>
                          </tr>
						...
						{{ csrf_field() }}
						<div id="ModalDelete{{ $contact->id }}" role="dialog" aria-modal="true" class="fade modal" tabindex="-1">
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										     <div class="container">
												 <div class="row">
													 <div class="col-lg-6">
														<a  name="send" class="btn btn-success  btn-block" href="contact-show/{{ $contact->id }}">Confirmer</a>
													 </div>
													 <div class="col-lg-6">
                  ...
                  {{-- <div class="contact" id="cont_show" style="display: none">
					  <div class="container">
						  <div class="row">
							 <div class="col-lg-8">
								<form action="{{ route('products.show',$product->id) }}" class="form-wrap " method="POST" action="{{ route('login.custom') }}">
									@if(Session::has('success'))
                                <div class="alert alert-success">
                                     {{Session::get('success')}} 
                                </div>
