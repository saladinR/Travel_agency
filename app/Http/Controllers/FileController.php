...
class FileController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if ( $request->hasFile( 'filenames1' ) ) {
            ...
            $file->move(public_path('data_app/image'), $extension1); 
         ...
         if ( $request->hasFile( 'filenames2' ) ) {
            ...
            $file->move(public_path('data_app/image'), $extension2); 
         ...
         if ( $request->hasFile( 'filenames3' ) ) {
            ...
            $file->move(public_path('data_app/image'), $extension3); 
         ...
         if ( $request->hasFile( 'filenames4' ) ) {
            ...
            $file->move(public_path('data_app/image'), $extension4); 
         ...
         if ( $request->hasFile( 'filenames5' ) ) {
            ...
            $file->move(public_path('data_app/image'), $extension5); 
         ...
         if ( $request->hasFile( "filenames6" ) ) {
            ...
            $file->move(public_path('data_app/image'), $extension6); 
