...
class FileController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if ( $request->hasFile( 'filenames1' ) ) {
            ...
            $file->move(storage_path('app/public/data_img'), $extension1); 
         ...
         if ( $request->hasFile( 'filenames2' ) ) {
            ...
            $file->move(storage_path('app/public/data_img'), $extension2); 
         ...
         if ( $request->hasFile( 'filenames3' ) ) {
            ...
            $file->move(storage_path('app/public/data_img'), $extension3); 
         ...
         if ( $request->hasFile( 'filenames4' ) ) {
            ...
            $file->move(storage_path('app/public/data_img'), $extension4); 
         ...
         if ( $request->hasFile( 'filenames5' ) ) {
            ...
            $file->move(storage_path('app/public/data_img'), $extension5); 
         ...
         if ( $request->hasFile( "filenames6" ) ) {
            ...
            $file->move(storage_path('app/public/data_img'), $extension6); 
